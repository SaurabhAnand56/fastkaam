    ...
    <section className="py-20 px-4 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <Link
            href="/blog"
            className="hidden sm:flex items-center gap-1 text-orange-500 font-semibold text-sm hover:gap-2 transition-all"
          >
        ...
        <div className="sm:hidden text-center mt-6">
          <Link href="/blog" className="text-orange-500 font-semibold text-sm">
            View all posts →
          </Link>
        </div>
      </div>
